...
## ⚡ ABOUT ME
## 👋 Hi there, I'm Doan Anh Quan!

🎓 **Mathematics & Computer Science Student at University of Science - VNUHCM**
📍 **Based in Vietnam**

I am an aspiring developer with a rigorous academic background, combining logical thinking from Mathematics with practical implementation in Computer Science. My goal is to leverage mathematical concepts to solve complex computational problems.
...
* 🏫 **Education:** Currently pursuing a Bachelor's in Math & CS at **VNUHCM - University of Science**.
* 🏆 **Background:** Alumnus of **Le Quy Don High School for the Gifted (Khanh Hoa)**.
...
* 🏋️ Pushing limits at the **Gym**.
* 📚 Reading books to broaden my perspective.
* 🎮 Gaming or analyzing films 🎬.
